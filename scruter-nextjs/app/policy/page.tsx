      ...
      <div className="container mx-auto max-w-2xl bg-white rounded-lg shadow-lg p-8 my-6">
        ...
        <div className="card bg-white shadow-md rounded-lg p-6 mb-4 transition-transform duration-300 hover:transform hover:translate-y-[-5px] hover:shadow-xl">
          ...
          <ul className="list-disc ml-5">
            <li><strong>Personal Information:</strong> Information you provide us directly, such as your name, email address, and phone number when you contact us or sign up for our services.</li>
            <li><strong>Usage Data:</strong> Information on how you access and use our website, including your IP address, browser type, pages visited, and the time spent on each page.</li>
          </ul>
        </div>
        ...
        <div className="card bg-white shadow-md rounded-lg p-6 mb-4 transition-transform duration-300 hover:transform hover:translate-y-[-5px] hover:shadow-xl">
          <h2 className="text-2xl font-semibold text-blue-800">How We Protect Your Information</h2>
        ...
        <div className="card bg-white shadow-md rounded-lg p-6 mb-4 transition-transform duration-300 hover:transform hover:translate-y-[-5px] hover:shadow-xl">
          <h2 className="text-2xl font-semibold text-blue-800">Sharing Your Information</h2>
