...
const Sidebar = () => (
  <aside className="w-1/4 bg-gradient-to-b from-blue-500 to-purple-600 text-white p-4 sticky top-0 h-screen">
    <ul className="space-y-4">
      <li><a href="#faq" className="flex items-center"><i className="fas fa-question-circle"></i> FAQs</a></li>
      <li><a href="#contact" className="flex items-center"><i className="fas fa-envelope"></i> Contact Support</a></li>
      <li><a href="#feedback" className="flex items-center"><i className="fas fa-comments"></i> Feedback</a></li>
      <li><a href="#resources" className="flex items-center"><i className="fas fa-book"></i> Resources</a></li>
      <li><a href="#troubleshooting" className="flex items-center"><i className="fas fa-wrench"></i> Troubleshooting</a></li>
    </ul>
  </aside>
);
  ...
  <div className="flex">
    ...
    <main className="w-3/4 p-8 bg-white shadow-lg">
      <div className="title-section text-center mb-8">
        ...
        <p className="text-gray-600 max-w-2xl mx-auto mt-2">We're here to help! Browse our resources or reach out for assistance.</p>
      </div>

      <Section id="faq" icon="fas fa-question-circle" title="Frequently Asked Questions (FAQs)">
        <p>Here are some common questions we receive from users:</p>
        <div className="faq-section mt-4">
          <div className="question font-semibold">How do I reset my password?</div>
          <div className="answer">To reset your password, go to the login page and click on "Forgot Password." Follow the instructions to reset your password.</div>
          <div className="question font-semibold mt-4">Where can I find my order history?</div>
          <div className="answer">You can find your order history in your account dashboard under "Order History."</div>
      ...
      <Section id="feedback" icon="fas fa-comments" title="Feedback">
        ...
        <a href="mailto:feedback@example.com" className="text-blue-600 hover:underline">Send Feedback</a>
      </Section>
      ...
      <Section id="troubleshooting" icon="fas fa-wrench" title="Troubleshooting">
        ...
        <ul className="list-disc pl-5">
          ...
          <li>Disable any browser extensions that may interfere with the website.</li>
        </ul>
      </Section>
    </main>
  </div>
