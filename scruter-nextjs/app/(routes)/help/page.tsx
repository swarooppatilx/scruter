...
const MainContent = () => (
  <main className="main-content flex-1 p-4 bg-white shadow-md">
    ...
    <Section id="faq" icon="fas fa-question-circle" title="Frequently Asked Questions">
      ...
      <FAQItem question="How can I contact customer support?" answer="You can contact customer support via email at support@example.com or call us at 1-800-555-0199." />
