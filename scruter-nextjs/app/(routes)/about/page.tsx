            ...
            <div className="container mx-auto max-w-4xl px-4">
              ...
              <div className="bg-white shadow-md rounded-lg p-6 my-6">
                ...
                <p className="text-gray-700 text-lg">
                  At our company, we believe in fostering strong local
                  connections and promoting sustainable, community-driven
                  commerce. Our platform is built to make buying and selling
                  easier, safer, and more accessible for everyone.
                </p>
              </div>
              ...
              <div className="bg-white shadow-md rounded-lg p-6 my-6">
                ...
                <p className="text-gray-700 text-lg">
                  ...
                  and connect with others in your community. From finding food
                  to housing, our platform brings your local market online.
                </p>
              </div>
