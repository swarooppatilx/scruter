...
import { PostListing, UpdateListing } from '@/actions/seller/listing';
...
type EditListingFormValues = z.infer<typeof formSchema>;
...
export const EditListingForm: React.FC<EditListingFormProps> = ({ initialData }) => {
  ...
  const description = 'Update the details to edit your listing.';
  const toastMessage = 'Listing updated.';
  const action = 'Update';
