  ...
  return (
    <>
      ...
      <main className="bg-secondary-mongolia relative h-screen md:overflow-hidden overflow-y-auto px-10 md:flex items-center justify-center font-ubuntu">
        ...
        <div className="hidden lg:block text-center text-4xl font-bold">Hey! Let&apos;s upload you first listing on SCRUTER</div>
        <Image src='/listingGuide.svg' width={1000} height={1000} alt="storeSetuppage" className="hidden md:block h-2/4 w-2/4"/>
        </div>
